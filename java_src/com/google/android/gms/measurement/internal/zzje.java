...
public final class zzje {
    ...
    private zzje(EnumMap<zza, zzjh> enumMap, int i3) {
    ...
    */
    ...
    public zzje(Boolean bool, Boolean bool2, int i3) {
    ...
    public static zzje zza(Bundle bundle, int i3) {
        if (bundle == null) {
            return new zzje(null, null, i3);
        }
        EnumMap enumMap = new EnumMap(zza.class);
        for (zza zzaVar : zzjg.STORAGE.zzd) {
    ...
    public static zzje zza(zzjh zzjhVar, zzjh zzjhVar2, int i3) {
        EnumMap enumMap = new EnumMap(zza.class);
    ...
    public static zzje zza(String str, int i3) {
        EnumMap enumMap = new EnumMap(zza.class);
        if (str == null) {
            str = "";
        }
        zza[] zzaVarArrZza = zzjg.STORAGE.zza();
        for (int i4 = 0; i4 < zzaVarArrZza.length; i4++) {
            zza zzaVar = zzaVarArrZza[i4];
            int i5 = i4 + 2;
            if (i5 < str.length()) {
                enumMap.put(zzaVar, zza(str.charAt(i5)));
            } else {
