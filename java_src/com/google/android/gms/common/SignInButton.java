...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    public SignInButton(Context context, AttributeSet attributeSet, int i3) {
        ...
        this.zad = null;
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C1385R.styleable.SignInButton, 0, 0);
        try {
            this.zaa = typedArrayObtainStyledAttributes.getInt(C1385R.styleable.SignInButton_buttonSize, 0);
            this.zab = typedArrayObtainStyledAttributes.getInt(C1385R.styleable.SignInButton_colorScheme, 2);
