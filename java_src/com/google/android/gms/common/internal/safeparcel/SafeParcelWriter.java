...
public class SafeParcelWriter {
    ...
    public static void writePendingIntent(Parcel parcel, int i3, PendingIntent pendingIntent, boolean z2) {
    ...
    public static void writeShort(Parcel parcel, int i3, short s2) {
        zzc(parcel, i3, 4);
        parcel.writeInt(s2);
    }
    ...
    public static <T extends Parcelable> void writeTypedArray(Parcel parcel, int i3, T[] tArr, int i4, boolean z2) {
        if (tArr == null) {
            if (z2) {
                zzc(parcel, i3, 0);
                return;
