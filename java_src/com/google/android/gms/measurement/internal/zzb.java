...
public final class zzb extends zze {
    ...
    static /* synthetic */ void zzb(zzb zzbVar, String str, long j3) {
        zzbVar.zzt();
    ...
    static /* synthetic */ void zza(zzb zzbVar, String str, long j3) {
        zzbVar.zzt();
        Preconditions.checkNotEmpty(str);
        if (zzbVar.zzb.isEmpty()) {
            zzbVar.zzc = j3;
