...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final Set zap = new C0922b();
    private final Set zaq = new C0922b();
    ...
    private final void zaJ(TaskCompletionSource taskCompletionSource, int i3, GoogleApi googleApi) {
        zacd zacdVarZaa;
        if (i3 == 0 || (zacdVarZaa = zacd.zaa(this, i3, googleApi.getApiKey())) == null) {
            return;
        }
    ...
    @ResultIgnorabilityUnspecified
    final boolean zaE(ConnectionResult connectionResult, int i3) {
    ...
    public final Task zap(GoogleApi googleApi, ListenerHolder.ListenerKey listenerKey, int i3) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
    ...
    public final void zau(GoogleApi googleApi, int i3, BaseImplementation.ApiMethodImpl apiMethodImpl) {
        this.zar.sendMessage(this.zar.obtainMessage(4, new zach(new zae(i3, apiMethodImpl), this.zam.get(), googleApi)));
    }

    public final void zav(GoogleApi googleApi, int i3, TaskApiCall taskApiCall, TaskCompletionSource taskCompletionSource, StatusExceptionMapper statusExceptionMapper) {
    ...
    final void zaw(MethodInvocation methodInvocation, int i3, long j3, int i4) {
        this.zar.sendMessage(this.zar.obtainMessage(18, new zace(methodInvocation, i3, j3, i4)));
    }

    public final void zax(ConnectionResult connectionResult, int i3) {
