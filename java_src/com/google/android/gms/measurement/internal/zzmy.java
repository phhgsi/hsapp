...
public final class zzmy<T extends Context & zznc> {
    ...
    public final int zza(final Intent intent, int i3, final int i4) {
        ...
        zzgoVarZzj.zzp().zza("Local AppMeasurementService called. startId, action", Integer.valueOf(i4), action);
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            zza(new Runnable() { // from class: com.google.android.gms.measurement.internal.zzna
                @Override // java.lang.Runnable
                public final void run() {
                    this.zza.zza(i4, zzgoVarZzj, intent);
                }
            });
        }
        return 2;
    ...
    final /* synthetic */ void zza(int i3, zzgo zzgoVar, Intent intent) {
        if (this.zza.zza(i3)) {
            zzgoVar.zzp().zza("Local AppMeasurementService processed last upload request. StartId", Integer.valueOf(i3));
