...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int i3, Activity activity, Fragment fragment, int i4, DialogInterface.OnCancelListener onCancelListener) {
        ...
        GoogleApiAvailability googleApiAvailability = GoogleApiAvailability.getInstance();
        if (fragment == null) {
            return googleApiAvailability.showErrorDialogFragment(activity, i5, i4, onCancelListener);
        }
        Dialog dialogZaa = googleApiAvailability.zaa(activity, i5, zag.zac(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i5, "d"), i4), onCancelListener, null);
        if (dialogZaa == null) {
            return false;
        }
