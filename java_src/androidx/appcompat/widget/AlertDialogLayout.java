...
public class AlertDialogLayout extends AbstractC0840Q {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* JADX INFO: renamed from: A */
    private void m3334A(View view, int i3, int i4, int i5, int i6) {
        view.layout(i3, i4, i5 + i3, i6 + i4);
    }

    /* JADX INFO: renamed from: B */
    private static int m3335B(View view) {
        int iM808z = AbstractC0268W.m808z(view);
        if (iM808z > 0) {
            return iM808z;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m3335B(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    private boolean m3336C(int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == AbstractC1765f.f8808P) {
                    view = childAt;
                } else if (id == AbstractC1765f.f8819k) {
                    view2 = childAt;
                } else {
                    if ((id != AbstractC1765f.f8821m && id != AbstractC1765f.f8823o) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            view2.measure(i3, 0);
            iM3335B = m3335B(view2);
            measuredHeight = view2.getMeasuredHeight() - iM3335B;
            paddingTop += iM3335B;
        ...
        if (view2 != null) {
            int i7 = paddingTop - iM3335B;
            int iMin = Math.min(i6, measuredHeight);
            if (iMin > 0) {
                i6 -= iMin;
                iM3335B += iMin;
            }
            view2.measure(i3, View.MeasureSpec.makeMeasureSpec(iM3335B, 1073741824));
    ...
    */
    private void m3337l(int r10, int r11) {
        /*
            r9 = this;
        ...
        L3b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.AlertDialogLayout.m3337l(int, int):void");
    }
    ...
    */
    protected void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
        ...
        L50:
            ...
            r9 = r3
            androidx.appcompat.widget.Q$a r9 = (androidx.appcompat.widget.AbstractC0840Q.a) r9
            int r3 = r9.gravity
            if (r3 >= 0) goto L74
            r3 = r2
        L74:
