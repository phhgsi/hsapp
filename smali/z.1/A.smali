...
.method private i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    .line 32
    invoke-static {v0, v1}, Lz/A;->n(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    .line 50
    invoke-static {v0, v4}, Lz/A;->n(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method private j(Landroid/os/CancellationSignal;LF/j$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/Font;
    .locals 1

    .line 1
    invoke-virtual {p2}, LF/j$b;->i()Z
    ...
    .line 6
    .line 7
    invoke-virtual {p0, p2}, Lz/A;->m(LF/j$b;)Landroid/graphics/fonts/Font;
    ...
    .line 12
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lz/A;->l(Landroid/os/CancellationSignal;LF/j$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/Font;
...
.method private l(Landroid/os/CancellationSignal;LF/j$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/Font;
    .locals 3
    ...
    .line 2
    :try_start_0
    invoke-virtual {p2}, LF/j$b;->e()Landroid/net/Uri;
    ...
    .line 52
    invoke-virtual {p2}, LF/j$b;->f()Ljava/lang/String;
...
.method public a(Landroid/content/Context;Ly/h$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    .line 46
    invoke-virtual {v3}, Ly/h$d;->d()Ljava/lang/String;
    ...
    .line 86
    .line 87
    invoke-direct {p0, p2, p4}, Lz/A;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[LF/j$b;I)Landroid/graphics/Typeface;
    ...
    .line 6
    :try_start_0
    invoke-virtual {p0, p2, p3, p1}, Lz/A;->k(Landroid/os/CancellationSignal;[LF/j$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 17
    .line 18
    invoke-direct {p0, p1, p4}, Lz/A;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public c(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    .line 11
    check-cast v0, [LF/j$b;

    .line 12
    .line 13
    invoke-virtual {p0, p2, v0, p1}, Lz/A;->k(Landroid/os/CancellationSignal;[LF/j$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 36
    check-cast v4, [LF/j$b;

    .line 37
    .line 38
    invoke-virtual {p0, p2, v4, p1}, Lz/A;->k(Landroid/os/CancellationSignal;[LF/j$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 53
    :cond_2
    invoke-direct {p0, v0, p4}, Lz/A;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method protected h([LF/j$b;I)LF/j$b;
    .locals 0
...
.method protected k(Landroid/os/CancellationSignal;[LF/j$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 5
    ...
    .line 8
    .line 9
    invoke-direct {p0, p1, v4, p3}, Lz/A;->j(Landroid/os/CancellationSignal;LF/j$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/Font;
...
.method protected m(LF/j$b;)Landroid/graphics/fonts/Font;
    .locals 1
