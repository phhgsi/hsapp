...
public final class zzag extends zzja {
    ...
    */
    ...
    public final int zza(String str, zzfz<Integer> zzfzVar, int i3, int i4) {
        return Math.max(Math.min(zzb(str, zzfzVar), i4), i3);
    }
    ...
    private final String zza(String str, String str2) {
        try {
            ...
            zzj().zzg().zza("Could not access SystemProperties.get()", e4);
            return str2;
        } catch (NoSuchMethodException e5) {
            zzj().zzg().zza("Could not find SystemProperties.get() method", e5);
            return str2;
