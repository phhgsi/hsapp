...
public final class zzdz extends GmsClient {
    ...
    private final C0929i zzf;
    private final C0929i zzg;
    private final C0929i zzh;
    private final C0929i zzi;
    ...
    public final void zzv(ListenerHolder.ListenerKey listenerKey, boolean z2, TaskCompletionSource taskCompletionSource) {
        synchronized (this.zzf) {
            try {
    ...
    public final void zzw(ListenerHolder.ListenerKey listenerKey, boolean z2, TaskCompletionSource taskCompletionSource) {
        synchronized (this.zzg) {
            try {
