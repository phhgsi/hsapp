...
public final class zzhe {
    ...
    public final Pair<String, Long> zza() {
        ...
        long j4 = this.zze.zzg().getLong(this.zzb, 0L);
        zzc();
        return (string == null || j4 <= 0) ? zzha.zza : new Pair<>(string, Long.valueOf(j4));
    }
    ...
    public final void zza(String str, long j3) {
        ...
        long j5 = j4 + 1;
        boolean z2 = (this.zze.zzq().zzv().nextLong() & Long.MAX_VALUE) < Long.MAX_VALUE / j5;
        SharedPreferences.Editor editorEdit2 = this.zze.zzg().edit();
        if (z2) {
            editorEdit2.putString(this.zzc, str);
        }
        editorEdit2.putLong(this.zzb, j5);
        editorEdit2.apply();
    }
}
