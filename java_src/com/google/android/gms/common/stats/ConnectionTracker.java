...
public class ConnectionTracker {
    ...
    private final boolean zzc(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i3, boolean z2, Executor executor) {
        ...
        try {
            boolean zZze = zze(context, intent, serviceConnection, i3, executor);
            if (zZze) {
                return zZze;
            }
            return false;
    ...
    private static final boolean zze(Context context, Intent intent, ServiceConnection serviceConnection, int i3, Executor executor) {
        if (executor == null) {
            executor = null;
        }
    ...
    @ResultIgnorabilityUnspecified
    public final boolean zza(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i3, Executor executor) {
