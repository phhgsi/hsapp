...
public class C0907o extends ImageButton {

    /* JADX INFO: renamed from: a */
    private final C0885d f3743a;

    /* JADX INFO: renamed from: b */
    private final C0909p f3744b;

    /* JADX INFO: renamed from: c */
    private boolean f3745c;

    public C0907o(Context context, AttributeSet attributeSet) {
    ...
    protected void drawableStateChanged() {
        ...
        C0885d c0885d = this.f3743a;
        if (c0885d != null) {
            c0885d.m3754b();
        }
        C0909p c0909p = this.f3744b;
        if (c0909p != null) {
            c0909p.m3868c();
        }
    }
    ...
    public boolean hasOverlappingRendering() {
        return this.f3744b.m3871f() && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        C0909p c0909p = this.f3744b;
        if (c0909p != null && drawable != null && !this.f3745c) {
            c0909p.m3873h(drawable);
        }
        super.setImageDrawable(drawable);
        C0909p c0909p2 = this.f3744b;
        if (c0909p2 != null) {
            c0909p2.m3868c();
            if (this.f3745c) {
                return;
    ...
    public C0907o(Context context, AttributeSet attributeSet, int i3) {
