...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        Field(int i3, int i4, boolean z2, int i5, boolean z3, String str, int i6, String str2, com.google.android.gms.common.server.converter.zaa zaaVar) {
            this.zai = i3;
            this.zaa = i4;
            this.zab = z2;
            this.zac = i5;
        ...
        public static Field withConverter(String str, int i3, FieldConverter<?, ?> fieldConverter, boolean z2) {
            fieldConverter.zaa();
            fieldConverter.zab();
            return new Field(7, z2, 0, false, str, i3, null, fieldConverter);
        }
