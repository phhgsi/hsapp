...
public abstract class RegisterListenerMethod<A extends Api.AnyClient, L> {
    ...
    protected RegisterListenerMethod(ListenerHolder<L> listenerHolder, Feature[] featureArr, boolean z2, int i3) {
    ...
    protected abstract void registerListener(A a3, TaskCompletionSource<Void> taskCompletionSource);
