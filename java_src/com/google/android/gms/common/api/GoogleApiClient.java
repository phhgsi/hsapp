...
public abstract class GoogleApiClient {
    ...
    public abstract void stopAutoManage(AbstractActivityC1080h abstractActivityC1080h);
    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                c0921a.put(api2, Boolean.valueOf(z3));
                ...
                c0921a2.put(api2.zab(), clientBuildClient);
            ...
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, clientSettingsZaa, this.zao, this.zap, c0921a, this.zaq, this.zar, c0921a2, this.zal, zabe.zad(c0921a2.values(), true), arrayList);
        ...
        public Builder enableAutoManage(AbstractActivityC1080h abstractActivityC1080h, int i3, OnConnectionFailedListener onConnectionFailedListener) {
            LifecycleActivity lifecycleActivity = new LifecycleActivity((Activity) abstractActivityC1080h);
        ...
        public Builder enableAutoManage(AbstractActivityC1080h abstractActivityC1080h, OnConnectionFailedListener onConnectionFailedListener) {
            enableAutoManage(abstractActivityC1080h, 0, onConnectionFailedListener);
            return this;
        }
