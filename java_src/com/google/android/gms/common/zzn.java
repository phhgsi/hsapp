...
final class zzn {
    ...
    static zzx zza(String str, zzj zzjVar, boolean z2, boolean z3) {
    ...
    static /* synthetic */ String zzd(boolean z2, String str, zzj zzjVar) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e3);
                    zzxVarZzd = zzx.zzd("module call", e3);
                }
            } catch (DynamiteModule.LoadingException e4) {
                Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e4);
                zzxVarZzd = zzx.zzd("module init: ".concat(String.valueOf(e4.getMessage())), e4);
            }
            StrictMode.setThreadPolicy(threadPolicyAllowThreadDiskReads);
            return zzxVarZzd;
        } catch (Throwable th) {
