        ...
        switch (zzbs.zza[zzg.zza(str).ordinal()]) {
            ...
            case 2:
                ...
                for (int i4 = 0; i4 < list.size() - 1; i4 += 2) {
                    ...
                    zzhVar.zzb(zzaqVarZza3.zzf(), zzhVar.zza(list.get(i4 + 1)));
                }
                return zzaq.zzc;
            case 3:
                if (list.isEmpty()) {
            ...
            case 4:
                ...
                while (i3 < list.size() - 1) {
                    zzaq zzaqVarZza5 = zzhVar.zza(list.get(i3));
                    zzaq zzaqVarZza6 = zzhVar.zza(list.get(i3 + 1));
            ...
            case 5:
                ...
                while (i3 < list.size()) {
                    zzaqVarZza7 = zzhVar.zza(list.get(i3));
