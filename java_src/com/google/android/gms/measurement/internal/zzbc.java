...
public final class zzbc {
    ...
    zzbc(zzhy zzhyVar, String str, String str2, String str3, long j3, long j4, Bundle bundle) {
        zzbe zzbeVar;
    ...
    final zzbc zza(zzhy zzhyVar, long j3) {
        return new zzbc(zzhyVar, this.zzc, this.zza, this.zzb, this.zzd, j3, this.zzf);
    }

    private zzbc(zzhy zzhyVar, String str, String str2, String str3, long j3, long j4, zzbe zzbeVar) {
        Preconditions.checkNotEmpty(str2);
        Preconditions.checkNotEmpty(str3);
