...
.method private a(Landroid/content/Context;LF/f;)Landroidx/emoji2/text/f$c;
    .locals 1
    ...
    .line 6
    .line 7
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/k;-><init>(Landroid/content/Context;LF/f;)V
...
.method private d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)LF/f;
    .locals 3
    ...
    .line 18
    .line 19
    invoke-direct {v1, v0, p1, v2, p2}, LF/f;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/f$c;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/d$a;->h(Landroid/content/Context;)LF/f;
    ...
    .line 5
    invoke-direct {p0, p1, v0}, Landroidx/emoji2/text/d$a;->a(Landroid/content/Context;LF/f;)Landroidx/emoji2/text/f$c;
...
.method h(Landroid/content/Context;)LF/f;
    .locals 2
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, v0, p1}, Landroidx/emoji2/text/d$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)LF/f;
