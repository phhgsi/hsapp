...
public final class zzlj extends zzh {
    ...
    static /* synthetic */ void zza(zzlj zzljVar, Bundle bundle, zzlk zzlkVar, zzlk zzlkVar2, long j3) {
        if (bundle != null) {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void zza(zzlk zzlkVar, boolean z2, long j3) {
        zzc().zza(zzb().elapsedRealtime());
        if (!zzp().zza(zzlkVar != null && zzlkVar.zzd, z2, j3) || zzlkVar == null) {
            return;
        }
        zzlkVar.zzd = false;
    }
