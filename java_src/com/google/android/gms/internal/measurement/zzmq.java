...
final class zzmq extends zzmr {
    ...
    @Override // com.google.android.gms.internal.measurement.zzmr
    final String zza(byte[] bArr, int i3, int i4) throws zzkb {
            ...
            while (i3 < i5) {
                ...
                if (b4 >= 0) {
                    ...
                    if (i8 < i5 - 1) {
                        int i10 = i3 + 2;
                        i3 += 3;
                        zzmo.zza(b4, bArr[i8], bArr[i10], cArr, i7);
                        i7++;
                    } else {
                        throw zzkb.zzd();
                    }
                    ...
                    byte b7 = bArr[i3 + 2];
                    i3 += 4;
                    zzmo.zza(b4, b6, b7, bArr[i11], cArr, i7);
                    i7 += 2;
                } else {
                    throw zzkb.zzd();
                }
