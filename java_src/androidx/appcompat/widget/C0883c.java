...
public class C0883c extends AutoCompleteTextView implements InterfaceC0991l {

    /* JADX INFO: renamed from: d */
    private static final int[] f3636d = {R.attr.popupBackground};

    /* JADX INFO: renamed from: a */
    private final C0885d f3637a;

    /* JADX INFO: renamed from: b */
    private final C0795A f3638b;

    /* JADX INFO: renamed from: c */
    private final C0901l f3639c;

    public C0883c(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, AbstractC1760a.f8712m);
    }

    /* JADX INFO: renamed from: a */
    void m3750a(C0901l c0901l) {
    ...
    protected void drawableStateChanged() {
        ...
        C0885d c0885d = this.f3637a;
        if (c0885d != null) {
            c0885d.m3754b();
        }
        C0795A c0795a = this.f3638b;
        if (c0795a != null) {
            c0795a.m3230b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f3638b.m3237j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f3638b.m3238k();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f3639c.m3839d(AbstractC0905n.m3856a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z2) {
        this.f3639c.m3840e(z2);
    }

    @Override // android.widget.TextView
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f3639c.m3836a(keyListener));
    }
    ...
    public void setSupportCompoundDrawablesTintList(ColorStateList colorStateList) {
        this.f3638b.m3250w(colorStateList);
        this.f3638b.m3230b();
    }

    @Override // androidx.core.widget.InterfaceC0991l
    public void setSupportCompoundDrawablesTintMode(PorterDuff.Mode mode) {
        this.f3638b.m3251x(mode);
        this.f3638b.m3230b();
    }
    ...
    public C0883c(Context context, AttributeSet attributeSet, int i3) {
        super(C0882b0.m3749b(context), attributeSet, i3);
        AbstractC0880a0.m3741a(this, getContext());
        C0888e0 c0888e0M3765v = C0888e0.m3765v(getContext(), attributeSet, f3636d, i3, 0);
