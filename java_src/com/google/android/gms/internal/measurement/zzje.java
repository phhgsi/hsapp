...
final class zzje extends zzie<Double> implements zzkc<Double>, zzlo, RandomAccess {
    ...
    public final int hashCode() {
        int iZza = 1;
        for (int i3 = 0; i3 < this.zzc; i3++) {
            iZza = (iZza * 31) + zzjv.zza(Double.doubleToLongBits(this.zzb[i3]));
        }
        return iZza;
    }
    ...
    public final /* synthetic */ zzkc<Double> zza(int i3) {
        if (i3 >= this.zzc) {
            return new zzje(i3 == 0 ? zza : Arrays.copyOf(this.zzb, i3), this.zzc, true);
        }
    ...
    private zzje(double[] dArr, int i3, boolean z2) {
        super(z2);
        this.zzb = dArr;
        this.zzc = i3;
    }
