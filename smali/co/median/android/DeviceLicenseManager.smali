...
.method public static checkLicense(Landroid/app/Activity;)V
    ...
    const-string v1, "global_access"
    const/4 v3, 0x0
    invoke-virtual {v2, v1, v3}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z
    move-result v1
    if-eqz v1, :cond_check_arr
    return-void

    :cond_check_arr
    const-string v1, "allowed_devices"
    invoke-virtual {v2, v1}, Lorg/json/JSONObject;->optJSONArray(Ljava/lang/String;)Lorg/json/JSONArray;
    move-result-object v1
    if-eqz v1, :cond_not_allowed
    ...
    invoke-static {p0, v1, v0}, Lco/median/android/DeviceLicenseManager;->showThemedUnauthorizedDialog(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
